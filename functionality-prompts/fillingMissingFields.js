...
- While in instruction I gave 3 example possibility as max, big amounts like 10 example field request can occur and you need to perfectly fill all 10. Make sure all the sentences are not too similar to each other, for reading comprehension, you can have little similar as that can rather help than all random.`;
